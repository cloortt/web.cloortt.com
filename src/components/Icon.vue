...
<template>
  ...
  <svg
    v-else-if="props.name === 'bank-card'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <svg
    v-else-if="props.name === 'file-edit'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <svg
    v-else-if="props.name === 'notification'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <!-- Lock Star Starts -->
  <svg
    v-else-if="props.name === 'lock-star'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <!-- Vip Crown Starts -->
  <svg
    v-else-if="props.name === 'vip-crown'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <!-- File Info Starts -->
  <svg
    v-else-if="props.name === 'file-info'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <!-- Arrow Right Starts -->
  <svg
    v-else-if="props.name === 'arrow-right'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <!-- File History Starts -->
  <svg
    v-else-if="props.name === 'file-history'"
    :width="props.size.width"
    :height="props.size.height"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
